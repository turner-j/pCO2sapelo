...
tbl = table(phase./10,vq4,Tsal./10,TSpCond./10,Tturb./10,TpH,TDO,Ttemp,co2lamp_filtered./100); % create a table with the response as the last variable
